		...
		return {
			...
			apps:{
				...
				perusahaan: [
					...
					{ nama: 'Konfirmasi Selesai', ikon: 'mdi-check-all', link:"/apps/perusahaan/1/konfirmasi" },
					{ nama: 'Cetak Laporan', ikon: 'mdi-printer', link:"/apps/perusahaan/1/cetak" },
					{ nama: 'Cetak Serah Terima', ikon: 'mdi-printer-check', link:"/apps/perusahaan/1/serahterima" },
				],
			},
			miniVariant: false,
			right: true,
