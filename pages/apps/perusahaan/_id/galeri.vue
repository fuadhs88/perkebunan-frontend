...
export default {
    ...
    watch:{
        triwulan: function(){
            this.crud.apiData               = `/v1/api/data/perusahaan_galeri/id_perusahaan/${this.id_perusahaan}?field1=triwulan&value1=${this.triwulan}`
    ...
    data(){
        return {
            ...
            crud: {
                ...
                apiData: `/v1/api/data/perusahaan_galeri/id_perusahaan/${this.id_perusahaan}?field1=triwulan&value1=${this.triwulan}`,
